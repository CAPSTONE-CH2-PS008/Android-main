...
class AddViewModel(private val repository: UserRepository): ViewModel() {
    ...
    fun addHabit(
        ...
        repository.insertHabit(activityName, bobot, activityCategory, startHour, endHour, interest, creationDate)
    }

    fun postPredict(Bobot: Int,
                    Activity: Int,
                    Start_Time: Int,
                    End_Time: Int,
                    Interest: Int) = repository.predict(Bobot, Activity, Start_Time, End_Time, Interest)
